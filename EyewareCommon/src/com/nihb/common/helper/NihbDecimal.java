...
* to scale (while {@link #eq(NihbDecimal)} is not) . That is,  
* <PRE>
...
*  }</PRE>
*/
public final class NihbDecimal implements Comparable<NihbDecimal>, Serializable {
  ...
  */
  public static final class MismatchedCurrencyException extends RuntimeException { 
	 ...
	 * 
	 */
	private static final long serialVersionUID = 6645433778364873455L;
  ...
  * {@link BigDecimal}.
  */
  public NihbDecimal(BigDecimal aAmount, Currency aCurrency, RoundingMode aRoundingStyle){
    fAmount = aAmount;
    fCurrency = aCurrency;
  ...
  */
  public NihbDecimal(BigDecimal aAmount){
  ...
  * @param aCurrency is required.
  */
  public NihbDecimal(BigDecimal aAmount, Currency aCurrency){
  ...
  * as this <tt>Money</tt>.
  */
  public boolean isSameCurrencyAs(NihbDecimal aThat){
  ...
  */
  public NihbDecimal plus(NihbDecimal aThat){
    checkCurrenciesMatch(aThat);
    return new NihbDecimal(fAmount.add(aThat.fAmount), fCurrency, fRounding);
  }
  ...
  * Currencies must match.  
  */
  public NihbDecimal minus(NihbDecimal aThat){
    checkCurrenciesMatch(aThat);
    return new NihbDecimal(fAmount.subtract(aThat.fAmount), fCurrency, fRounding);
  }
...
//  
  ...
  public static NihbDecimal sum(List<NihbDecimal> moneys, Currency currency){
	  NihbDecimal sum = new NihbDecimal(ZERO, currency);
	  for(NihbDecimal money : moneys)
		  sum = sum.plus(money);
	  
	  return sum;
  } 
  
  public static NihbDecimal sum(List<NihbDecimal> moneys){
	  return sum(moneys, DEFAULT_CURRENCY);
  }
  ...
  */
  public boolean eq(NihbDecimal aThat) {
    checkCurrenciesMatch(aThat);
  ...
  */
  public boolean gt(NihbDecimal aThat) { 
    checkCurrenciesMatch(aThat);
    return compareAmount(aThat) > 0;  
  }
  ...
  */
  public boolean gteq(NihbDecimal aThat) { 
    checkCurrenciesMatch(aThat);
    return compareAmount(aThat) >= 0;  
  }
  ...
  * 'that' amount. Currencies must match. 
  */
  public boolean lt(NihbDecimal aThat) { 
    checkCurrenciesMatch(aThat);
    return compareAmount(aThat) < 0;  
  }
  ...
  * 'that' amount. Currencies must match.  
  */
  public boolean lteq(NihbDecimal aThat) { 
    checkCurrenciesMatch(aThat);
    return compareAmount(aThat) <= 0;  
  }
  ...
  * <tt>Money</tt>.
  */
  public NihbDecimal times(int aFactor){  
    BigDecimal factor = new BigDecimal(aFactor);
    BigDecimal newAmount = fAmount.multiply(factor);
    return new NihbDecimal(newAmount, fCurrency, fRounding);
  }
  ...
  * 'this' <tt>Money</tt>. 
  */
  public NihbDecimal times(double aFactor){
  ...
  * 'this' <tt>Money</tt>. 
  */
  public NihbDecimal div(int aDivisor){
  ...
  * The {@link #eq(NihbDecimal)} method, on the other hand, is <em>not</em> 
  * sensitive to scale.
  */
  public boolean equals(Object aThat){
    if (this == aThat) return true;
    if (! (aThat instanceof NihbDecimal) ) return false;
    NihbDecimal that = (NihbDecimal)aThat;
  ...
  public int compareTo(NihbDecimal aThat) {
    final int EQUAL = 0;
  ...
  */  
  ...
  private void checkCurrenciesMatch(NihbDecimal aThat){
  ...
  private int compareAmount(NihbDecimal aThat){
